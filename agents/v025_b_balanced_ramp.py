"""
Candidate V025-B: Balanced Cow + Early Strawberry Ramp
------------------------------------------------------
Features:
1. Early Strawberry Deployment: Begins buying and planting strawberries from Day 2 onwards (as soon as cash >= $100 and tiles exist).
2. Intra-Day Cow Velocity: Unlocks Cow purchasing from Day 4 onwards whenever money >= $1,500.
3. Proactive Labor Scaling: Hires 4 workers on Day 4 and 7 workers on Days 5-7 to handle simultaneous watering, care, and planting.
4. Compact 3-Quadrant layout with Hungarian assignment core.
"""
