"""
Agent V026-A: IL Hybrid
-----------------------
Hybrid architecture combining:
1. IL Empirical Opening: Day 0 starts with 1 Cow + 3 Sheep + 9 Melons + 5 Wheat + 4 Hires.
   - Cash spent: Cow ($400) + 3 Sheep ($1500) + 9 Melons ($720) + 5 Wheat ($50) + 4 Hires ($7) + Feed ($200) = $2,877.
   - Gives early milk and wool cashflow from Day 3 without depleting liquidity.
2. Controlled Cow Ramp (Cap 9): Cow purchases triggered intra-day at $500 threshold, but bounded to 9 cows.
   - Prevents market saturation / milk price collapse observed in 13-cow variants.
3. Massive Strawberry Engine (Days 6-20): Expands up to 40 strawberries across Q2/Q3, capturing $200+ strawberry market prices.
4. Bounded Labor (Cap 12): Worker hires scale with land and animals but strictly bound to 12 workers max.
5. Full V025-A Hungarian Safety Shield: Guarantees zero starve, zero weeds, urgent watering.
"""
...
def agent(obs):
    ...
    if day == 0 and hour == 0:
        ...
        if hour in [1, 6, 12, 18]:
            ...
            # Strawberry Engine: Days 6 to 20, up to 40 strawberries
        ...
        # Dynamic Selling Priority (Strawberries & Milk first, then Wool/Melons)
