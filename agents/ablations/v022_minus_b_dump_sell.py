"""
Ablation B: V022-C minus Paced Sales (Hour 0 Bulk Dump)
"""
import math
...
def agent(obs):
    ...
    if day == 0 and hour == 0:
        ...
        # ABLATION: All produce dumped in bulk at Hour 0, NO PACING at hours 2-23
        if hour == 0:
            ...
            if hires_today < target_hands and money >= 2:
                for _ in range(min(target_hands - hires_today, 10 - len(market_orders))): market_orders.append(["HIRE"])
        elif hour == 1:
