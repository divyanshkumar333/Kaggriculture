...
class DailyPlanner:
    ...
    def plan_tasks(self):
        ...
        for crop_name in crop_actions.keys():
            ...
            # V015-C: Marginal Production Caps
            next_price = self.econ.get_price_at_inventory(crop_name, sim_inv + 1)
            base_price = MARKET_PARAMS.get(crop_name, {}).get("base", 50)
            if next_price < 0.70 * base_price:
                continue
