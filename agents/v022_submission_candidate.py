...
--------------------------------------------------------------------
- Paced multi-hour market pipeline: Hour 0 HIRE, Hour 1 Capital, Hours 2-23 Paced Selling.
- Quad-matched labor capacity scaling (2 -> 6 -> 10 -> 12 workers).
- Compact 16-pasture livestock sector around shed.
- Guaranteed 3-day feed buffer and urgent watering priority.
"""
