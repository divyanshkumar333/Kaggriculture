"""
EXP-038 (V057_DemandResidual)
-----------------------------
V057 base trace + Kaito's Demand-Aware Market Ranking.
The harmful `_front_run` logic is removed entirely.
This is a pure causal test of the market logic isolated from farming execution.
"""
