"""
Candidate V023-E: "Cows-First" Hyper-Compounding Flywheel
---------------------------------------------------------
Based on exact Kaggle top-replay empirical trace:
1. Day 6: Reinvest Day 6 Wool ($5k) IMMEDIATELY into Q2 Unlock + 4 Cows (reaching 4 Sheep + 4 Cows = 8 animals).
2. Days 7-8: Milk cash flow immediately funds Cows 9, 10, 11 by Day 9.
3. Days 9-10: Giant Strawberry burst (45 plants) funded by $5,000/day livestock cash flow.
4. Days 11-25: 11 Cows (22 milk/day @ $180) + 4 Sheep (8 wool/day @ $240) + 45 Strawberries (90/day @ $120).
5. Days 26-29: Full endgame liquidation.
"""
...
def agent(obs):
    ...
    if day == 0 and hour == 0:
        ...
        # HOUR 1: CAPITAL DEPLOYMENT (Land, Cows-First, Seeds, Feed)
            ...
            # 2. PRIORITY COW ACCELERATION (Reaching 11 Cows by Day 9)
            ...
            # 3. Large-Scale Strawberry & Wheat Seeds (Ramped after Cow cash arrives on Day 9)
            if day >= 9 and day <= 24 and money >= 300:
