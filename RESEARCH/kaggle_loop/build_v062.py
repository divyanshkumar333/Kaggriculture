...
def agent(obs, configuration=None):
    ...
    # Check opponent hires for Melon seeds (they might be holding them)
    # Actually we can't see opponent private state (shed/seeds).
    # But we CAN see their plants!
