...
def run_benchmarks():
    agent_v054 = "agents/v054_economic_ranker.py"
    ...
    matchups = [
        ("V054_EconomicRanker", agent_v054, "V053_MarketAdaptive", agent_v053),
        ("V054_EconomicRanker", agent_v054, "V16_Public", agent_v16),
        ("V054_EconomicRanker", agent_v054, "V027_Base", agent_v027),
    ]
