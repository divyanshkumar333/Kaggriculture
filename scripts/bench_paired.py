"""
Sequential paired benchmark harness.
Usage:
    python scripts/bench_paired.py <agent_a_file> <agent_b_file> --seeds 8 --start 9000

Both seats tested: seed S -> A vs B, B vs A.
Reports W/T/L, win_score, mean cash delta, 95% bootstrap CI.
"""
import argparse, importlib.util, json, math, random, sys, traceback
...
def run_game(agent_a, agent_b, seed, max_steps=720):
    from kaggle_environments import make
    env = make("kaggriculture", configuration={"episodeSteps": max_steps + 1,
                                                "randomSeed": seed}, debug=False)
...
def main():
    ...
    for seed in seeds:
        r0a, r0b = run_game(agent_a, agent_b, seed)
        r1b, r1a = run_game(agent_b, agent_a, seed + 1000000)
