...
def benchmark_v020_c():
    print("==================================================")
    print("RUNNING V020-C SURGICAL COMPETITIVE BENCHMARK")
    ...
    for name, opp_path in OPPONENTS.items():
        res = run_matchup("agents/v020_c_competitive_surgical.py", opp_path, SEEDS)
        summary[name] = res
        total_wins += res["wins"]
    ...
    print("\n==================================================")
    print(f"OVERALL V020-C: Win Rate: {overall_win_rate:.1f}% | Mean Bank: ${mean_bank:.0f} | Worst Case: ${min_bank:.0f}")
    print("==================================================")
    
    with open("experiments/v020_c_benchmark.json", "w") as f:
