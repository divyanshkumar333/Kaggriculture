...
if __name__ == "__main__":
    variants = {
        "v007_a_control": "agents/v007_a_control.py",
        "v007_b_clustered": "agents/v007_b_clustered.py",
        "v007_c_sector_planting": "agents/v007_c_sector_planting.py"
    }
    ...
    with open("experiments/v007_benchmark_results.json", "w") as f:
        json.dump(full_results, f, indent=2)
        
    print("Results saved to experiments/v007_benchmark_results.json")
