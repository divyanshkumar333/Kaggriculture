...
class StrategyConfig:
    def __init__(self,
        ...
        self.max_hires_per_day = 5
        self.hyper_hire_day = 0
        
        # Load from config.json if it exists
        import os, json
        config_path = "experiments/005_dynamic_livestock/config.json"
...
class TaskAllocator:
    ...
    def allocate(self):
        ...
        # Hyper-Hires Strategy
        if self.state.day <= self.strategy.config.hyper_hire_day and self.state.hires_today < self.strategy.config.max_hires_per_day and self.state.hour < 23:
