...
if __name__ == "__main__":
    variants = {
        "v006_a_control": "agents/v006_a_control.py",
        "v006_b_sectors": "agents/v006_b_sectors.py",
        "v006_c_tsp": "agents/v006_c_tsp.py"
    }
    ...
    with open("experiments/v006_benchmark_results.json", "w") as f:
        json.dump(full_results, f, indent=2)
        
    print("Results saved to experiments/v006_benchmark_results.json")
