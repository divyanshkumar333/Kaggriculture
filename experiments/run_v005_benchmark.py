...
if __name__ == "__main__":
    variants = {
        "v005_a_control": "agents/v005_a_control.py",
        "v005_c_best_animal": "agents/v005_c_best_animal.py",
        "v005_d_combined": "agents/v005_d_combined.py"
    }
    ...
    with open("experiments/v005_benchmark_results.json", "w") as f:
        json.dump(full_results, f, indent=2)
        
    print("Results saved to experiments/v005_benchmark_results.json")
